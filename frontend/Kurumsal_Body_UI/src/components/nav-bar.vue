...
export default {
  data() {
    return {
      languages: [
        {
          flag: require("@/assets/images/flags/tr.svg").default,
          language: "tr",
          title: "Türkçe",
        },
        {
          flag: require("@/assets/images/flags/us.svg").default,
          language: "en",
          title: "English",
        },
      ],
        ...
        <div class="d-flex">
          ...
          <div class="navbar-brand-box horizontal-logo">
            <router-link to="/" class="logo logo-dark">
              <span class="logo-sm">
                <img
                  src="@/assets/images/common/alisan-logo.png"
                  alt=""
                  height="22"
                />
              </span>
              <span class="logo-lg">
                <img
                  src="@/assets/images/common/alisan-logo-normal.png"
                  alt=""
                  height="17"
                />
              </span>
        ...
        <div class="d-flex align-items-center">
          ...
          <div class="dropdown ms-sm-3 header-item topbar-user">
            ...
            <div class="dropdown-menu dropdown-menu-end">
              ...
              >
              <a class="dropdown-item" href="/auth/logout-basic"
                ><i
