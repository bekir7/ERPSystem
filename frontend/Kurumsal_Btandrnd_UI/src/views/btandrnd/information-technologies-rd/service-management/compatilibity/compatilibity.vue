  ...
  methods: {
    getCompatibility() {
      axios
        ...
        .then(({ data }) => {
          this.compatibilitys = data;
          this.$nextTick(() => {
            $("#myCompatibilityTable").DataTable({
              responsive: true,
              language: {
                  ...
                  <div class="modal-body" style="background-color: #F1F1F1;">
                    <div class="card">
                      <div class="card-header align-items-center d-flex">
                        <h4 class="card-title mb-0 flex-grow-1"> {{ $t("t-compatibility") }}
                        </h4>
                      </div>
                      <div class="card-body">
                                    ...
                                    <div class="card-body">
                                      <div class="row g-3">
                                        ...
                                        <div class="col-xxl-4">
                                          <div>
                                            <label for="birim" class="form-label form-label-sm">
                                              {{ $t("t-reminder-time") }}</label>
                                            <input type="date" class="form-control form-control-sm" />
                                          </div>
                                        </div>
                                        <div class="col-xxl-12">
                                          <label for="aciklamaInput" class="form-label"> {{ $t("t-request-detail") }}
                                          </label>
              ...
              <div class="col-xxl-2">
                    <div>
                      ...
                      <input
                        ...
                        list="datalistCodeCompatilibity"
                        id="exampleDataList"
                        :placeholder="$t('t-choose')"
                      />
                      <datalist id="datalistCodeCompatilibity"> </datalist>
                    </div>
                  </div>
                  <div class="col-xxl-2">
                    <div>
                      <label class="form-label"> {{ $t("t-situation") }}</label>
                      <input
                        class="form-control form-control-sm"
                        list="datalistStationCompatilibity"
                        id="exampleDataList"
                        :placeholder="$t('t-choose')"
                      />
                      <datalist id="datalistStationCompatilibity"> </datalist>
                    </div>
                  </div>
                  ...
                  <div class="flex-grow-1 ms-2">
                    <div class="row">
                      <div class="card card-body">
                        <div class="card-body">
                          <div class=" table-responsive table-card" style="width: 100% !important">
                            <table style="width: 100% !important; margin-right: -200px;" id="myCompatibilityTable"
                              class="listingTable table align-middle table-nowrap">
                              <thead class="table-light text-muted">
                                <tr>
                                  <th class="sort" scope="col">{{ $t("t-code") }}</th>
                                  <th class="sort" scope="col"> {{ $t("t-application") }}
                                  </th>
                                  <th class="sort" scope="col">{{ $t("t-situation") }}
                                  </th>
                                  <th class="sort" scope="col">{{ $t("t-request") }}
                                  </th>
                                </tr>
                              </thead>
                              <tbody class="list form-check-all">
                                <tr v-for="compatibility in compatibilitys" :key="compatibility.id">
