...
add(){
  ...
  axios.post("http://localhost:54558/api/hukukdurusma/create", newRequest)
...
add2(){
  ...
  axios.post("http://localhost:54558/api/law/update2", newRequest)
                   .then(res => this.Request = res.data)
},
created() {
      axios
                                ...
                                <div class="card-body">
                                  ...
                                  <div class="col-xxl-5">
                                        ...
                                        <div class="hstack gap-2 justify-content-end">
                                          ...
                                          <b-button data-bs-toggle="table" data-bs-target="#nav-badge-fatura"  variant="success" @click="add2(); " >
                                             {{ "Saat Ekle" }}</b-button>
                                  ...
                                  <table  style="width: 100% !important; margin-right: -200px; " 
                                    ...
                                    <thead class="table-light text-muted">
                                      <tr>
                                        ...
                                        <th class="sort" scope="col" >{{ ("Durusma Saati") }}</th>
                                    ...
                                    <tbody class="list form-check-all">
                                      <tr v-for="request in Request" :key="request.id">
                                        ...
                                        <td>{{ request.date }}</td>
                                        <td>{{ request.time }}:{{ request.time2 }}</td>
